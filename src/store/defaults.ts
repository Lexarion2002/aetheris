...
export const DEFAULT_DOMAINS: Domain[] = [
  {
    ...
    color: 'green',
    icon: '🏃',
    description: 'Forme physique, alimentation, sommeil et bien-être corporel',
  },
  {
    id: 'career',
    name: 'Carrière',
    color: 'blue',
    icon: '💼',
    description: 'Travail, projets professionnels et évolution de carrière',
  },
  {
    id: 'learning',
    name: 'Apprentissage',
    color: 'indigo',
    icon: '📚',
    description: 'Formation, compétences nouvelles et développement intellectuel',
  },
  {
    id: 'relationships',
    name: 'Relations',
    color: 'pink',
    icon: '🤝',
    description: 'Famille, amis, réseau et connexions humaines',
  },
  {
    id: 'creativity',
    name: 'Créativité',
    color: 'purple',
    icon: '🎨',
    description: 'Art, musique, écriture et expression personnelle',
  },
  {
    id: 'wellbeing',
    name: 'Bien-être',
    color: 'teal',
    icon: '🧘',
    description: 'Santé mentale, méditation, équilibre et sérénité',
  },
]
